...
device='cpu'
model = torch.load('./model_checkpoints/test_model/epoch_18.pkl', map_location = device)
...
plt.savefig('pure_test.jpg', dpi = 600)
plt.clf()
...
plt.scatter([0]*len(preds0), preds0, c = 'red')
plt.ylim(sorted(preds)[5] - 0.000001, sorted(preds)[-5] + 0.000001)
plt.savefig('flip_test.jpg', dpi = 600)
plt.close()
...
plt.scatter([0]*len(preds0), preds0, c = 'red')
plt.ylim(sorted(preds)[5] - 0.000001, sorted(preds)[-5] + 0.000001)
plt.savefig('flip_rotate_test.jpg', dpi = 600)
plt.close()
...
plt.scatter([0]*len(preds0), preds0, c = 'red')
plt.ylim(sorted(preds)[5] - 0.000001, sorted(preds)[-5] + 0.000001)
plt.savefig('rotate_test.jpg', dpi = 600)
plt.close()
